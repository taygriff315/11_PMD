...
namespace SAT.UI.MVC.Controllers
{
    ...
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewBag.ScheduledClassId = new SelectList(db.ScheduledClasses, "SchdeuledClassId", "InstructorName");
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,StudentId,ScheduledClassId,EnrollmentDate")] Enrollment enrollment)
        {
            ...
            ViewBag.ScheduledClassId = new SelectList(db.ScheduledClasses, "SchdeuledClassId", "InstructorName", enrollment.ScheduledClassId);
